...
#   这两个需要改一下
SH_ROUTE=/home/dzw/Computer-Architecture-Learning/notes/Lab2/sim
REC_ROUTE=/home/dzw/Computer-Architecture-Learning/time_rec
...
##  做 Simpoint 时需要改一下
TEST_ROUTE=/home/dzw/Computer-Architecture-Learning/riscv-coremark/coremark

##  这个对应的是测试 ELF 的地址
##  做 Simpoint 时需要改一下
SE_ELF_ROUTE=${TEST_ROUTE}/coremark.exe
...
#   simpoint 安装的地址
#   做 simpoint 时需要改一下
SIMPOINT_PATH=/home/dzw/SimPoint.3.2-fix
